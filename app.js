...
// function start(submitButton, pointA, pointB, imperialOption, metricOption, imperialPrice, metricPrice) {
//     var distance;
//     submitButton.click(function(event){
//     event.preventDefault();
//     var pointAInput = pointA;
//     var pointBInput = pointB;
//     var directionsService = new google.maps.DirectionsService;
//     var directionsDisplay = new google.maps.DirectionsRenderer;
...
// $(document).ready(function() {
//     start($('.submit-button'), $('#pac-input').val(), $('#pac-input2').val(), $('.imperial-option'), $('metric-option'), $('.imperial-price'), $('.metric-price'))
// });
